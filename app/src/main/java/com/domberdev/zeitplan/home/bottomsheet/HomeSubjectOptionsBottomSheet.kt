...
class HomeSubjectOptionsBottomSheet(private val onItemClickListener: OnSettingsSubjectListener): BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        editSubjectBottom.setOnClickListener {
            ...
            findNavController().navigate(R.id.homeToEditSubject, bundle)
            dismiss()
        }
        deleteSubject()
    }
